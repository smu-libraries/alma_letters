...
<xsl:template name="recordTitle">
			<div class="recordTitle">
				<b><span class="spacer_after_1em"><xsl:value-of select="notification_data/phys_item_display/title"/></span></b>
			</div>
			<xsl:if test="notification_data/phys_item_display/author !=''">
				<div class="">
					<span class="spacer_after_1em">
						<b><span class="recordAuthor">By: <xsl:value-of select="notification_data/phys_item_display/author"/></span></b>
					</span>
				</div>
			</xsl:if>
